...
export class OperationsController {
  ...
  @Get("products") products() { return this.operations.products(); }
  @Post("products") createProduct(@Body() dto: CreateOperationalProductDto) { return this.operations.createProduct(dto); }
  @Delete("products/:id") deleteProduct(@Param("id") id: string) { return this.operations.deleteProduct(id); }
  @Get("warehouses") warehouses() { return this.operations.warehouses(); }
  @Post("warehouses") createWarehouse(@Body() dto: CreateOperationalWarehouseDto) { return this.operations.createWarehouse(dto); }
  ...
  @Get("returns") returns() { return this.operations.returns(); }
  @Roles(RoleName.ADMIN, RoleName.SELLER, RoleName.WAREHOUSE)
  @Post("returns/:type") createReturn(@Param("type") type: string, @Body() dto: CreateReturnDto) { return this.operations.createReturn(type, dto); }

  @Get("payment-methods") paymentMethods() { return this.operations.paymentMethods(); }
  @Get("accounts/:type") accounts(@Param("type") type: string) { return this.operations.accounts(type); }
  @Roles(RoleName.ADMIN, RoleName.SELLER)
  @Post("accounts/:type/payments") registerAccountPayment(@Param("type") type: string, @Body() dto: RegisterOperationalPaymentDto) {
